...
public class SubscriptionAcknowledge {
  ...
  @ApiModelProperty(example = "627aa72a-c799-4abf-b98e-0c4838af9bd5", value = "The acknowledge identifier (UUID v4).")
  public UUID getAcknowledgeId() {
    return acknowledgeId;
  }
   
  @ApiModelProperty(example = "2020-04-12T22:20:50.52Z", value = "Date and time when the acknowledge was sent. As defined by date-time - RFC3339.")
