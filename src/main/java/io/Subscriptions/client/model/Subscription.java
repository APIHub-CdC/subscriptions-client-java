...
public class Subscription {
  ...
  @ApiModelProperty(example = "mx.com.circulolaboral.employmentverification", required = true, value = "Event type you are interested in.")
  ...
  @ApiModelProperty(example = "470987ab-b4cb-4a1e-9eaf-8856a813da59", required = true, value = "Your enrollment identifier to associate with the subscription identifier (UUID v4).")
  ...
  @ApiModelProperty(example = "4fc07667-b928-4a5c-a9d4-e18d3d515d24", value = "Subscription identifier (UUID v4).")
  public UUID getSubscriptionId() {
    return subscriptionId;
  }
   
  @ApiModelProperty(example = "2020-04-12T22:20:50.52Z", value = "Date and time when the subscription was created. As defined by date-time - RFC3339.")
